...
Algs.BFSCanvasCell = class extends UI.AbstractCanvasCell {
  ...
  #setTip(sprite, e) {
    ...
    let status_str;
    if (status === BFSNodeStatus.Queued) status_str = "Queued";
    else if (status === BFSNodeStatus.Expanding) status_str = "Expanding";
    else if (status === BFSNodeStatus.Visited) status_str = "Visited";
    else if (status === BFSNodeStatus.Undiscovered) status_str = "Undiscovered";
    else if (status === BFSNodeStatus.Path) status_str = "Path!";
