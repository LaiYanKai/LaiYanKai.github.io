...
Algs.Parameters = class {
    ...
    validate() {
        ...
        if (!Utils.isEnum(this.node_connectivity, AlgNodeConnectivity))
            throw new Error(`"node_connectivity" must be null or a value from AlgNodeConnectivity`);
        ...
        if (!Utils.isEnum(this.next_neighbor, AlgNextNeighbor))
            throw new Error(`"next_neighbor" must be null or a value from AlgNextNeighbor`);
        ...
        if (!Utils.isEnum(this.time_ordering, AlgTimeOrdering))
            throw new Error(`"time_ordering" must be null or a value from AlgTimeOrdering`);
        ...
        if (!Utils.isEnum(this.costmap_type, AlgCostmapType))
            throw new Error(`"costmap_type" must be null or a value from AlgCostmapType`);
